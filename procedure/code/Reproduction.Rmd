...
ggsave(path = output_maps, "fig2.png", height = 4, width = 6, scale = 2.5)
...
```{r}
ggarrange(void1, void2, void3, void1, void2, void3, void3, void3, void3, font.label = list(size = 23, color = "red"),
                    labels = c("A", "D", "G", "B", "E", "H", "C", "F", "I"), heights = c(1,5,5),
                    ncol = 3, nrow = 3)

ggsave(path = output_maps, "fig5.png", height = 4, width = 6, scale = 3.8)

ggarrange(void1, void2, void3, void1, void2, void3, void3, void3, void3,
                    labels = c("A", "D", "G", "B", "E", "H", "C", "F", "I"), heights = c(1,5,5),
                    ncol = 3, nrow = 3)
```
